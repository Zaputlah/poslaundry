...
const PageLaundry = () => {
  ...
  const onGetProducts = () => {
    ...
    axios.get(`${import.meta.env.VITE_BASE_URL_LAUNDRY}/products`, config)
      .then((response) => {
  ...
  const onCreateOrder = (status) => {
    ...
    axios.post(`${import.meta.env.VITE_BASE_URL_LAUNDRY}/orders`, payload)
      .then(() => {
        alert("Sukses!!!")
      }).catch((error) => {
        alert(`Error ${error}`);
  ...
  const onUpdateOrder = (status) => {
    ...
    axios.put(`${import.meta.env.VITE_BASE_URL_LAUNDRY}/orders/${order.id}/`, payload)
      .then(() => {
        alert("Sukses!!!")
      }).catch((error) => {
        alert(`Error ${error}`);
  ...
  const onHandlerOrder = (e) => {
    ...
    orderValidator.setValidator((values) => ({...values, 
      [name]: {
